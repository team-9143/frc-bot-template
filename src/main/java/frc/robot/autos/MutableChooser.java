...
/**
 * A {@link edu.wpi.first.wpilibj.smartdashboard.SendableChooser SendableChooser}-like class allowing for the editing of options.
 * Use {@link MutableChooser#isUpdateReq()} to check if an update is necessary on shuffleboard by selecting the default option.
 */
public class MutableChooser<T extends Enum<T> & MutableChooser.Named> implements NTSendable, AutoCloseable {
